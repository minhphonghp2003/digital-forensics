export const abi =[
	...
	},
	{
		"inputs": [
			...
			{
				"internalType": "enum PhongStorage.SystemLogSeverity",
				"name": "severity",
				"type": "uint8"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct PhongStorage.SystemLog[]",
				"name": "",
				"type": "tuple[]"
			}
		],
